...
| 2 | سطح إثبات | عرض منتج ثابت وآمن للخصوصية قبل طلب الثقة. | نفس الشكل ومعاه وصف نصي مكافئ؛ الصورة مش مصدر المعنى الوحيد. | إمكانات منشورة فقط؛ تسميات اصطناعية دون بيانات غرفة. |
